    ...
    <section className="hero" style={{paddingTop: '100px'}}>
      <div className="container" style={{position: 'relative'}}>
        <div className="hero-split">
          ...
          <div className="hero-visual" style={{flex: '1.2'}}>
            <div className="visual-wrapper" style={{position: 'relative', width: '120%', right: '-10%', transform: 'scale(1.1)'}}>
              <img src="/images/banner-02.png" alt="Effission Ecosystem" className="visual-img" style={{filter: 'brightness(1.1) contrast(1.1)'}} />
            </div>
          </div>
        </div>
