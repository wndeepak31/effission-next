        ...
        <section className={styles.section} style={{ position: 'relative', zIndex: 1 }}>
          <div className={styles.wideContainer}>
            <div className={styles.contactLayout} style={{
              ...
              <div style={{ flex: '0 0 30%', paddingRight: '10px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '60px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{ color: 'rgba(255,255,255,0.8)', fontSize: '14px' }}>sales@effission.com</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ color: 'var(--accent-gold, #ed8b16)' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', color: 'var(--accent-gold, #ed8b16)' }}>
              ...
              <div style={{ flex: '1', padding: '0 20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div className={styles.formRow}>
                  <input type="text" placeholder="Name*" style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: '#fff', fontSize: '13px', outline: 'none' }} />
                  <input type="text" placeholder="Company*" style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: '#fff', fontSize: '13px', outline: 'none' }} />
                </div>
                <div className={styles.formRow}>
                  <input type="email" placeholder="Email*" style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: '#fff', fontSize: '13px', outline: 'none' }} />
                  <input type="tel" placeholder="Phone*" style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: '#fff', fontSize: '13px', outline: 'none' }} />
                </div>
                <div style={{ position: 'relative' }}>
                  <select style={{ width: '100%', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: 'rgba(255,255,255,0.6)', fontSize: '13px', appearance: 'none', outline: 'none' }}>
                ...
                <textarea placeholder="Message*" rows="4" style={{ width: '100%', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', padding: '14px 16px', color: '#fff', fontSize: '13px', resize: 'vertical', outline: 'none', minHeight: '100px' }}></textarea>

                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
                  <button style={{ backgroundColor: '#c78132', color: '#fff', border: 'none', borderRadius: '4px', padding: '14px 32px', fontSize: '14px', fontWeight: 500, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ flex: '0 0 26%', paddingLeft: '20px' }}>
